...
export function CompareTool({ darkMode, setError }: CompareToolProps) {
  ...
  return (
    <div className="jd-wrapper">
      ...
      {/* Input Textareas */}
      <div className={`grid grid-cols-1 md:grid-cols-2 ${border} border-b`}>
        <div className={`flex flex-col ${border} md:border-r`}>
          ...
          <textarea
            ...
            className={`jd-textarea ${darkMode ? 'jd-textarea-dark' : 'jd-textarea-light'}`}
          />
        </div>
      ...
      <div>
        {hasResult ? (
          ...
          <div className={`flex flex-col items-center justify-center py-20 ${textDim} text-center gap-3`}>
            ...
            <p className="text-sm max-w-md leading-relaxed">
              Paste two JSON payloads above and click <strong>Compare</strong> to see a git-style side-by-side diff.
            </p>
          </div>
        )}
      </div>
